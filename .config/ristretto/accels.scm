...
;
 ...
 (gtk_accel_path "<Actions>/RsttoWindow/sort-random" "")
 (gtk_accel_path "<Window>/unfullscreen" "Escape")
 (gtk_accel_path "<Actions>/RsttoWindow/sort-order-desc" "")
